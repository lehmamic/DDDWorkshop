...
namespace VaughnVernon.Mockroservices
{
    ...
    public class EventJournalPublisher
    {
        ...
        private CancellationTokenSource dispatcherThreadCancellation;
        ...
        public void Close()
        {
            ...
            this.dispatcherThreadCancellation.Cancel();
        }
            ...
            string topicName)
        {
            ...
            this.dispatcherThreadCancellation = new CancellationTokenSource();
            this.dispatcherThread = new Thread(new ThreadStart(() => this.DispatchEach(this.dispatcherThreadCancellation.Token)));

            StartDispatcherThread();
        }

        internal void DispatchEach(CancellationToken cancellationToken)
        {
